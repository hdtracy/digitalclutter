...
### **Table of Podcast log entries from daily notes** based on [[Leah Ferguson]]'s [[Start and End your Day with a Daily Note]]
```sql
TABLE
...
### **Table of D&D session log entries from notes** based on [[Leah Ferguson]]'s 
```sql
TABLE WITHOUT ID 
